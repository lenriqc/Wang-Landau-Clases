...
/*parece ser que por lo menos a partir de 2014 es necesario en ubuntu lo siguiente:
"If you are going to use --with-x11 you need the xorg-dev package installed.
/sudo apt-get install xorg-dev" NO RESULTA*/
